...
- **31 componentes** en el catálogo, **28 con envolvente**. Los tres que no la
...
- **42 huecos sin aproximación** (`TBD`), **28 números inventados aquí**
  (`supuesto`) y **9 discrepancias** entre fuentes.
...
- **26 piezas colocadas** y **0 choques de geometría**. Todos los componentes de
  la payload opción B y de la plataforma están dibujados y situados.
- **18 keep-outs**, todos dibujados con números supuestos, porque las tres cotas
  que los dimensionan —radio de curvatura de la fibra, el del coaxial y el
  diámetro de haz— siguen siendo TBD. Hay 14 invasiones, y el informe las
...
- Zona útil interior **221.7 × 95.4 × 361.4 mm = 7.64 L**, de la que quedan
  **2.88 L libres**. Era 5.84 L cuando 19 componentes no ocupaban nada; la
...
| El banco óptico, en la línea que va del eje del telescopio a la pared | **7.7 mm** de margen. El FSM tiene que estar sobre el eje óptico porque es el que dobla el haz, y eso deja al colimador y al dicroico en fila con él: 74.0 mm para 66.3 mm de piezas. No se ve mirando volúmenes —en el banco sobra hueco— y las dos envolventes que lo llenan son **supuestas**. |
