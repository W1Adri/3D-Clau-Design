...
Resumen: **21** no comprobable, **16** ok
...
| e01 | opticas_espacio_libre | colimador | dicroico_d1 | haz_libre | no comprobable | 30 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
| e02 | opticas_espacio_libre | dicroico_d1 | fsm | haz_libre | no comprobable | 28 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
...
| e04 | opticas_espacio_libre | dicroico_d1 | dicroico_d2 | haz_libre | no comprobable | 28 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
| e05 | opticas_espacio_libre | telescopio_cassegrain | EXTERIOR | apertura | ok | - | Extremos colocados y holgura declarada |
| e06 | opticas_espacio_libre | dicroico_d2 | camara_beacon | haz_libre | no comprobable | - | Sin colocar: camara_beacon. No se puede medir el recorrido ni comprobar la holgura. |
| e07 | opticas_espacio_libre | laser_beacon_bajada | dicroico_d2 | haz_libre | no comprobable | 32 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
| e08 | opticas_espacio_libre | dicroico_d2 | dicroico_d1 | haz_libre | no comprobable | 28 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
| e09 | opticas_espacio_libre | dicroico_d1 | trampa_luz_d1 | haz_libre | no comprobable | 24 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
| e10 | opticas_espacio_libre | dicroico_d2 | fotodiodo_monitor_beacon | haz_libre | no comprobable | 22 | Extremos colocados, pero sin holgura de conector declarada: no se puede afirmar que quepa. |
