...
| Ocupado por piezas colocadas | 4727.1 | 4.73 |
| Ocupado segun catalogo (con o sin colocar) | 4308.7 | 4.31 |
| Libre dentro de la zona util | 2916.6 | 2.92 |
...
> Sin colocar (5): `radio_uhf_pulsar_vutrx`, `propulsion`, `camara_beacon`, `mod_fase_mpz_ln_10`, `cables_rf_moduladores`.
...
| OPT-12 | laser_beacon_bajada | Laser de beacon de bajada (1064 nm) | aproximado propio: caja | supuesto | 1 | 18.8 | 30 x 25 x 25 | 0 | (33, 28, -47) | si |
| OPT-03 | mod_fase_mpz_ln_10 | Exail MPZ-LN-10 (modulador de fase, codificador de polarizacion) | aproximado propio: caja | referencia | 1 | 16.0 | - | 0 | - | no |
| OPT-02 | mod_intensidad_mxer_ln_10 | Exail MXER-LN-10 (modulador de intensidad, grado espacial EM/NS-FM/FM) | aproximado propio: caja | confirmado | 1 | 16.0 | 10 x 25 x 130 | 2 | (98, -28, 46) | si |
| OPT-07 | acoplador_monitor | Acoplador 2x2 de monitorizacion + dos fotodiodos | aproximado propio: caja | supuesto | 1 | 14.4 | 12 x 20 x 60 | 1 | (98, 36, 11) | si |
| OPT-09 | dicroico_d1 | Dicroico D1 (separacion canal cuantico / beacons) | aproximado propio: caja | supuesto | 1 | 12.2 | 23 x 23 x 23 | 0 | (65, 0, -47) | si |
| OPT-15 | dicroico_d2 | Dicroico D2 (separacion beacon de subida / beacon de bajada) | aproximado propio: caja | supuesto | 1 | 12.2 | 23 x 23 x 23 | 0 | (65, 28, -47) | si |
| OPT-11 | camara_beacon | Camara / sensor de beacon de subida (medida del error de apuntado) | aproximado propio: caja | supuesto | 1 | 8.0 | - | 0 | - | no |
| OPT-19 | espejo_plegado_cuantico | Espejo de plegado del canal cuantico (plano metalico a 45 grados) | aproximado propio: caja | supuesto | 1 | 8.0 | 20 x 20 x 20 | 0 | (91, 0, -47) | si |
| OPT-08 | colimador | Colimador fibra a espacio libre | aproximado propio: cilindro | supuesto | 1 | 4.0 | 12 x 12 x 28 | 0 | (91, 0, -5) | si |
...
| OPT-17 | trampa_luz_d1 | Trampa de luz del cuarto puerto de D1 | aproximado propio: caja | supuesto | 1 | 3.4 | 15 x 15 x 15 | 0 | (65, -24, -47) | si |
| OPT-16 | fotodiodo_monitor_beacon | Fotodiodo de monitorizacion de potencia del beacon de bajada | aproximado propio: caja | supuesto | 1 | 1.7 | 12 x 12 x 12 | 0 | (87, 28, -47) | si |
...
| OPT-04 | voa | Atenuador optico variable (VOA) | aproximado propio: cilindro | supuesto | 1 | 1.1 | 6 x 6 x 35 | 2 | (98, 28, 66) | si |
...
| Payload (telescopio, franja, banco y bandeja) | 4195.9 | 1986.5 | 2209.4 | 2.21 | 47% |
...
| z_payload_franja | Franja lateral - modulacion, monitorizacion, atenuacion y codificacion | 501.8 | 51.0 | 450.8 | 0.45 | 10% |
| z_payload_banco | Banco optico de espacio libre | 638.6 | 64.2 | 574.3 | 0.57 | 10% |
| z_payload_bandeja | Bandeja optica de fibra | 1235.3 | 51.1 | 1184.3 | 1.18 | 4% |

## Supuestos pendientes de sustituir (75)
