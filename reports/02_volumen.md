...
|---|---|---|---|---|---|---|---|---|---|---|
| OPT-13 | telescopio_cassegrain | Telescopio Cassegrain on-axis, apertura 90 mm | aproximado propio: cilindro (esperando STEP) | supuesto | 1 | 1820.2 | 95 x 95 x 200 | 0 | (37, 0, 81) | si |
...
## Supuestos pendientes de sustituir (28)
