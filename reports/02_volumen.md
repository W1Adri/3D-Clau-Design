...
| Ocupado por piezas colocadas | 4750.6 | 4.75 |
| Ocupado segun catalogo (con o sin colocar) | 4300.7 | 4.30 |
| Libre dentro de la zona util | 2893.0 | 2.89 |
...
> Sin colocar (4): `radio_uhf_pulsar_vutrx`, `propulsion`, `camara_beacon`, `cables_rf_moduladores`.
...
| Payload (telescopio, franja, banco y bandeja) | 4195.9 | 2010.1 | 2185.8 | 2.19 | 48% |
...
| z_payload_banco | Banco optico de espacio libre | 638.6 | 60.3 | 578.3 | 0.58 | 9% |
| z_payload_bandeja | Bandeja optica de fibra | 1235.3 | 66.5 | 1168.8 | 1.17 | 5% |

## Supuestos pendientes de sustituir (68)
