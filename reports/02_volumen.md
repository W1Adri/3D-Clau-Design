...
| paneles_photon_side | AAC Clyde Space PHOTON-SIDE (paneles de montaje en cuerpo) | plataforma | supuesto | 2 | 511.3 | (0, 52, 0) | si |
| bateria_optimus_30 | AAC Clyde Space Optimus-30 (bateria) | plataforma | referencia | 2 | 372.7 | (-61, 0, -56) | si |
| eps_starbuck_nano_plus | AAC Clyde Space Starbuck-Nano-PLUS (EPS) | plataforma | confirmado | 1 | 180.0 | (-61, 0, 59) | si |
| radio_banda_s_quasar_strx | AAC Clyde Space Quasar-STRX (transceptor banda S) | plataforma | referencia | 1 | 146.0 | (-61, 0, 28) | si |
| pcb1_control_qkd | PCB-1 Control QKD (FPGA, QRNG, memoria, reloj) | payload_pcb | supuesto | 1 | 129.7 | (-61, 0, -10) | si |
| pcb2_drivers_opticos | PCB-2 Drivers opticos | payload_pcb | supuesto | 1 | 129.7 | (-61, 0, -25) | si |
| pcb3_pat | PCB-3 PAT (apuntado, adquisicion y seguimiento) | payload_pcb | supuesto | 1 | 129.7 | (-61, 0, 5) | si |
| antena_quasar_wsant | AAC Clyde Space Quasar-WSANT (antena banda S) | plataforma | supuesto | 1 | 67.2 | (-61, 0, -176) | si |
| obc_kryten_m3_plus | AAC Clyde Space Kryten-M3-PLUS (OBC con GNSS) | plataforma | referencia | 1 | 47.6 | (-61, 0, 89) | si |
...
| cables_rf_moduladores | Coaxiales RF de PCB-2 a los dos moduladores | payload_pcb | TBD | 2 | - | - | no |
